...
<meta http-equiv="description" content="This is the single page">
...
<body>
	<div class="container">
		<div class="header">
		      ...
		      <img src="<%=stylePath%>images/banner2.jpg" alt="在此处插入徽标" name="logo"  id="Insert_logo" 
		      style=" display:block;" />
		...
		<div class="self">
			...
			<span class="selfUser"><%=user.getName() %></span>&nbsp;&nbsp;|&nbsp;
			<span>消息</span>
		</div>
			<div class="slider">
				 
				<ul>
					<li><a href="<%=commonPagePath%>singleCenter.jsp" class="active">
					<i class="icon-home"></i>
					<span>主页</span>
					<b class="icon-right"></b>
					</a></li>

					<li><a href="<%=commonPagePath%>singleCMessage.jsp"  >
					<i class="icon-home"></i>
					<span>消息</span>
					<b class="icon-right"></b>
					</a></li>
					...
					<li><a href="<%=commonPagePath%>"  >
					<i class="icon-home"></i>
					<span>通知</span>
					<b class="icon-right"></b>
					</a></li>

					<li><a href="<%=commonPagePath%>singleCSet.jsp"  >
					<i class="icon-home"></i>
					<span>设置</span>
					<b class="icon-right"></b>
					</a></li>
			...
			<div class="u-container">
				...
				<div class="news">
					<p><a>关于发布前沿科技创新2016年度项目需求的通知</a><span class="news-time">07/15</span></p>
					<hr />
